package com.example.wangjingyun.commonrecycleview.creator;
...
import com.example.wangjingyun.commonrecycleview.R;
...
public class RefreshCreator extends RefreshViewCreator {
    ...
    public View getRefreshView(Context context, ViewGroup parent) {
        ...
        View refreshView = LayoutInflater.from(context).inflate(R.layout.item_twomainhead_layout, parent, false);
        return refreshView;
